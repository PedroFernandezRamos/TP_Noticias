...
@Component({
  selector: 'app-palabra-clave-page',
  templateUrl: './palabra-clave-page.component.html',
  styleUrls: ['./palabra-clave-page.component.css']
})
export class PalabraClavePageComponent {
  ...
  buscarNoticiasPorPalabraClave(fuente: string){
    this.loading = true;
    this.listadoDeNoticias=[];

    setTimeout(() => {
    this._api.getNoticiasPorPalabraClave(fuente).subscribe((resultado)=>
      {
